...
from modules.data_sync import info_path
from modules.data_sync import update_pppline_monitor_to_control_node
...
def traffic_speed_and_pingloss_collection():
    ...
    def get_pppline_bandwitch():
        ...
        # 创建上下行数据写入到到监控信息字典
        pppline_monitor_info_path = os.path.join(info_path, 'pppline_monitor_info.json')
